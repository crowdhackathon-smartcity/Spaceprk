 ...
 * @version 1.1.0
 */
public interface IWheelPickerDateData {
    ...
    void setOnItemSelectedListener(WheelPickerDateData.OnItemSelectedListener listener);
    ...
    void setOnWheelChangeListener(WheelPickerDateData.OnWheelChangeListener listener);

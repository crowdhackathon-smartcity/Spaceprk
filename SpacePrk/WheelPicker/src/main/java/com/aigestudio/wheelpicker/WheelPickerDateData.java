 ...
 * @version 1.1.0
 */
public class WheelPickerDateData extends View implements IDebug, IWheelPickerDateData, Runnable {
    /**
     * 滚动状态标识值
     *
    ...
    private static final String TAG = WheelPickerDateData.class.getSimpleName();
    ...
    public WheelPickerDateData(Context context) {
        this(context, null);
    }

    public WheelPickerDateData(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(WheelPickerDateData picker, Object data, int position);
    }
    ...
    public interface OnWheelChangeListener {
         ...
         *              {@link WheelPickerDateData#SCROLL_STATE_IDLE}
         *              表示滚动选择器处于静止状态
         *              {@link WheelPickerDateData#SCROLL_STATE_DRAGGING}
         *              表示滚动选择器处于拖动状态
         *              {@link WheelPickerDateData#SCROLL_STATE_SCROLLING}
         *              表示滚动选择器处于滑动状态
         *              <p>
